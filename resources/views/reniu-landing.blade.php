...
<head>
    ...
    <title>Reniu — Insurans &amp; Cukai Jalan</title>
    <meta name="description" content="Pembaharuan insurans kenderaan dan cukai jalan dengan pilihan bayaran ansuran daripada Reniu.">
...
@php
    // Reniu branding. The logo comes from the site config (public/images/reniu-my.png);
    // company name is "Reniu". Content below mirrors the NAN Solutions landing.
    ...
    $reviews    = [
        ...
        ['Nur Aisyah',          '4 months ago', 5, 'Cepat dan mesra. Renew roadtax dan insurans terus settle dalam masa singkat. Terima kasih Reniu!'],
    ];
@endphp
...
<x-hero-background id="utama">
        ...
        <nav class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 sm:h-20">
                <a href="#utama" class="flex items-center gap-3 shrink-0">
                    ...
                    @else
                        <span class="font-display font-bold text-xl sm:text-2xl text-white tracking-wide drop-shadow">RENIU</span>
                    @endif
                </a>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 pb-32 sm:pb-40">
        ...
        <div class="grid grid-cols-12 gap-6 items-center">
            ...
            <!-- right -->
            <div class="col-span-12 md:col-span-6">
                <x-img-slot class="aspect-[4/3]" src="images/Background-Header-Image.webp" alt="Reniu">Imej Kanan</x-img-slot>
            </div>
        </div>
    </div>
</x-hero-background>
...
<section id="tentang" class="py-16 sm:py-20 bg-gradient-to-b from-[#DA5813] to-[#F59A5B]">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div class="col-span-12 md:col-span-6">
                <x-img-slot class="aspect-[4/3] object-contain" src="images/Gambar-Kereta-Payung.webp" alt="Reniu">Imej Kanan</x-img-slot>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="grid grid-cols-12 mt-10 sm:mt-14">
            <div class="col-span-12 text-center max-w-4xl mx-auto">
                <p class="font-semibold leading-relaxed text-[#33406B] text-base sm:text-lg">
                    Kami di Reniu komited untuk membantu anda memahami hak serta manfaat insurans
...
<!-- ══ §5 INSURANCE COMPANIES — heading | auto-scroll logos ══════════════ -->
...
<!-- ══ §8 PRODUK & PERKHIDMATAN — 9 cards, icon + payment button ═════════ -->
...
<section id="hubungi" class="bg-[#FFF7F1] py-16 sm:py-20">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-xl">
            ...
            @else
                <span class="font-display font-bold text-2xl text-[#E2661F] tracking-wide">RENIU</span>
            @endif
...
<footer class="bg-brand-ink text-white/70">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-12 gap-8 text-sm">
        <div class="col-span-12 sm:col-span-6">
            <span class="font-display font-bold text-xl tracking-wide"><span class="text-[#F0813A]">RENIU</span></span>
...
<!-- ══ Floating WhatsApp ════════════════════════════════════════════════ -->
<a href="{{ site()->whatsappLink() ?: 'https://wa.link/aib22q' }}" target="_blank" rel="noopener"
