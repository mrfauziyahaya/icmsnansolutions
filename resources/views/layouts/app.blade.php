                                ...
                                <ul role="list" class="flex flex-1 flex-col gap-y-7">
                                    <li>
                                        <ul role="list" class="-mx-2 space-y-1">
                                            ...
                                            <li>
                                                <a href="{{ route('whatsapp.index') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-orange-200 hover:bg-orange-700 hover:text-white {{ request()->routeIs('whatsapp.index') ? 'bg-orange-700 text-white' : '' }}">
                                                    <svg class="size-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                            ...
                                            <li>
                                                <a href="{{ route('quote-requests.index') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-orange-200 hover:bg-orange-700 hover:text-white {{ request()->routeIs('quote-requests.*') ? 'bg-orange-700 text-white' : '' }}">
                                                    <svg class="size-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                            ...
                                            <li>
                                                <a href="{{ route('payments.index') }}" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-orange-200 hover:bg-orange-700 hover:text-white {{ request()->routeIs('payments.*') ? 'bg-orange-700 text-white' : '' }}">
                                                    <svg class="size-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    ...
                                    <li class="mt-auto">
                                        <a href="{{ route('settings.edit') }}" class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-orange-200 hover:bg-orange-700 hover:text-white {{ request()->routeIs('settings.edit') ? 'bg-orange-700 text-white' : '' }}">
                                            <svg class="size-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
