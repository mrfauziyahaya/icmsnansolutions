<x-legal-layout title="Privacy Policy">
    ...
    <p>“Personal Data” is any information which can be used to identify you or from which you are identifiable. This includes but is not limited to your name, nationality, telephone number, bank and credit card details, personal interests, email address, your image, government-issued identification numbers, biometric data, race, date of birth, marital status, religion, health information, vehicle and insurance information.</p>

    <h2>Collection of Personal Data</h2>
    <p>We collect Personal Data about you in the ways listed below. We may also combine the collected Personal Data with other Personal Data in our possession.</p>

    <h3>You provide your Personal Data to us</h3>
    ...
    <ul>
        ...
        <li>use biometric features to identify yourself; and</li>
        <li>fill up demographic information in surveys.</li>
    </ul>

    <h3>When our services are used</h3>
    <p>Personal Data may be collected through the normal operation of our Apps, Websites, Services. Some examples are:</p>
    <ul>
        <li>your location (to detect driving locations and driving patterns);</li>
        <li>feedback, ratings and compliments;</li>
        <li>transaction information (such as payment method and distance travelled);</li>
        <li>information about how you interacted with our Apps, Website or services (such as features used and content viewed);</li>
        <li>device information (such as hardware model and serial number, IP address, file names and versions and advertising identifiers);</li>
        <li>personal data you enter in messages when you use our in-app communication features; and</li>
        <li>vehicle data you enter to verify vehicle for insurance purchase.</li>
    </ul>

    <h3>From other sources</h3>
    <p>When we collect Personal Data from other sources, we make sure that data is transferred to us in accordance with applicable laws. Such sources include:</p>
    <ul>
        <li>referral programmes;</li>
        <li>our business partners, such as agent partners, payment providers, enterprise partners and transport partners;</li>
        <li>insurance and financial providers;</li>
        <li>publicly available data;</li>
        <li>governmental sources of data;</li>
        <li>when our users add you as an emergency contact; and</li>
        <li>marketing services providers or partners.</li>
    </ul>

    <p>Personal Data about referral-partners. If you are a referral-partner, we may collect:</p>
    <ul>
        ...
        <li>your vehicle insurance policy.</li>
    </ul>
    ...
    <ul>
        <li>provide you with Services across our various business verticals;</li>
        <li>engage you to provide Services;</li>
        <li>create, administer and update your account;</li>
        <li>verify your identity;</li>
        <li>validate your vehicle and process payments;</li>
        <li>offer, obtain, provide or facilitate insurance or financing solutions;</li>
        <li>track your driving behaviour and detect abnormal driving patterns;</li>
        <li>enable features that personalise your App, such as lists of your favourite places and previous destinations;</li>
    ...
    <h3>Research and development and security</h3>
    ...
    <p>We may communicate such marketing to you by post, telephone call, short message service, online messaging service, push notification, by hand and by email. If you wish to unsubscribe to the processing of your Personal Data for marketing and promotions, please click on the unsubscribe link in the relevant email or message. Alternatively, you may also update your preferences in our App settings.</p>
    ...
    <h3>Other users</h3>
    <p>For example, if you are a customer, we may share your locations with referrals. If you are a referral, we may share your Personal Data with your customer including your name and photo, your average rating, full name and age.</p>

    <h3>With third-parties</h3>
    <p>For example, we may share a customer name and information with third parties (insurers, reinsurers) when a customer uses the Customer Service feature or activates Renew Automatically.</p>
    ...
    <h3>With our legal advisors and governmental authorities</h3>
    <p>We may share your Personal Data with our legal advisors, law enforcement officials, government authorities and other third parties.</p>

    <h2>Retention / Deletion / Disposal of Personal Data</h2>
    <p>We will retain personal data for as long as necessary to fulfil our business purposes, unless a longer retention period is required or permitted by law. Personal data that is no longer required will be securely and irreversibly deleted/disposed or anonymized in accordance with the deletion and disposal procedures.</p>
